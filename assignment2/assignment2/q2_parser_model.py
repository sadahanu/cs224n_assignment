...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        tf_embeddings = tf.Variable(self.pretrained_embeddings, name="pretrained_embeddings")
        input_embeddings = tf.nn.embedding_lookup(tf_embeddings, self.input_placeholder)
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        W = tf.get_variable(shape=[self.config.n_features*self.config.embed_size, self.config.hidden_size], initializer=xavier_weight_init(), name="W")
        U = tf.get_variable(shape=[self.config.hidden_size, self.config.n_classes], initializer=xavier_weight_init(), name="U")
